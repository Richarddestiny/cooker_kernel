...
#define ILITEK_TP_CMD_SET_CDC_INITIAL_V6		                    0xF1    //no support V3 protocol
...
extern int api_protocol_get_key_info_v3(uint8_t *inbuf, uint8_t *outbuf);
...
extern int api_protocol_get_tp_resolution_v6(uint8_t *inbuf, uint8_t *outbuf);
